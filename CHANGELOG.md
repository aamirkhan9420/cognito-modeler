...
All notable changes to the [Cognito Modeler](https://github.com/finos/fluxnova-modeler) are documented here. We use [semantic versioning](http://semver.org/) for releases.
...
- Updated the "Learn more" link in the change execution platform pop-up to point to https://docs.cognito.vodafone.com/
