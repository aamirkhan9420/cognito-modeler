...
describe('<EngineProfile>', function() {
  ...
  describe('#getStatusBarLabel', function() {
    ...
    it('should return correct annotated versions', function() {
      ...
      // given
      const inputs =
            [ [ ENGINES.COGNITO, '7.23.0', 'Cognito 7.23 (unsupported)' ],
              [ ENGINES.COGNITO, '1.0.0', 'Cognito 1.0' ],
              [ ENGINES.COGNITO, '', 'Cognito' ]
      ];
  ...
  describe('BPMN', function() {
    ...
    it('should show description', function() {
      ...
      // then
      // todo: Uncomment once documentation available (https://github.com/finos/cognito-modeler/issues/8)
...
//   expectHelpText(wrapper, 'https://docs.cognito.finos.org/manual/latest/');
// }
