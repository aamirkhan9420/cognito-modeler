...
describe('<FormEditor>', function() {
  ...
  describe('import', function() {
    ...
    it('should import with error', async function() {
      ...
      // when
      await renderEditor('{ "executionPlatform":"Cognito Platform", "importError": true }', {
        onImport: onImportSpy
      });
  ...
  describe('engine profile', function() {
    ...
    it('should show engine profile (Cognito 1.0.0)', expectEngineProfile(engineProfileSchema, {
      executionPlatform: 'Cognito Platform',
      executionPlatformVersion: '1.0.0'
    }));


    it('should show engine profile (Cognito 1.0)', expectEngineProfile(missingPatchEngineProfile, {
      executionPlatform: 'Cognito Platform',
      executionPlatformVersion: '1.0.0'
    }));


    it('should show engine profile (Cognito 1.0.1)', expectEngineProfile(patchEngineProfile, {
      executionPlatform: 'Cognito Platform',
    ...
    it('should update cached engine profile on change', async function() {
      ...
      schema.executionPlatform = 'Cognito Platform';
        schema.executionPlatform = 'Cognito Platform';
    ...
    it('should open unknown execution profile form as Cognito Platform', async function() {
  ...
  describe('cognito conversion', function() {
  it('existing form to cognito', async function() {/* Lines 1334-1358 omitted */});
  it('when model is already cognito', async function() {/* Lines 1366-1384 omitted */});

    describe('should convert', function() {

      it('existing form to cognito', async function() {
        ...
        expect(schema.executionPlatform).to.be.eql('Cognito Platform');
    ...
    describe('should not convert', function() {
      ...
      it('when model is already cognito', async function() {
