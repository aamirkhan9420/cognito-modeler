...
describe('tabs/form/linting - FormLinter', function() {
  ...
  describe('lint', function() {
    ...
    it('should show lint errors for "form-element-type" rule', function() {
      ...
      // then
      expect(reports).to.eql([
        { id: 'test_checkbox', label: 'Checkbox', message: 'A <Checkbox> is not supported by Cognito Platform test_ver', category: 'error' }
      ]);
    ...
    it('should show lint errors for "no-submit-button" rule', function() {
      ...
      // then
      expect(reports).to.eql([
        { id: 'test_submit', label: 'Submit', message: 'Submit buttons will be hidden in favor of built-in ones in the Cognito Tasklist.', category: 'info' }
      ]);
