...
import existingCognitoXML from './existing.cognito.dmn';
...
describe('<DmnEditor>', function() {
  ...
  describe('cognito conversion', function() {
    ...
    describe('should convert', function() {
      ...
      it('existing model to cognito', async function() {
        ...
        expect(convertedXML).to.contain('namespace="http://fluxnova.finos.org/schema/1.0/dmn"'); // URL, do not change
    ...
    describe('should not convert', function() {
      ...
      it('when model is already cognito', async function() {
        ...
        // when
        await renderEditor(existingCognitoXML, {
          onAction: onAction,
          onContentUpdated: onContentUpdated
        });
  ...
  describe('engine profile', function() {
    ...
    it('should show engine profile (Cognito 1.0.0)', expectEngineProfile(engineProfileXML, {
      executionPlatform: 'Cognito Platform',
    ...
    it('should open unknown engine profile as Cognito', async function() {
