...
import existingCognitoModel from './existing.cognito.bpmn';
...
describe('<BpmnEditor>', function() {
  ...
  describe('cognito conversion', function() {
    ...
    describe('should convert', function() {
      ...
      it('existing model to cognito', async function() {
        ...
        expect(convertedXML).to.contain('xmlns:cognito="http://fluxnova.finos.org/schema/1.0/bpmn"');
        expect(convertedXML).to.contain('modeler:executionPlatform="Cognito Platform"');
      ...
      it('existing model that uses camunda extended attributes to cognito', async function() {
    ...
    describe('should not convert', function() {
      ...
      it('when model is already cognito', async function() {
        ...
        // when
        await renderEditor(existingCognitoModel, {
          onContentUpdated
        }, onAction);
  ...
  describe('engine profile', function() {
    ...
    it('should show engine profile (Cognito 1.0)', expectEngineProfile(missingPatchEngineProfileXML, {
      executionPlatform: 'Cognito Platform',
      executionPlatformVersion: '1.0.0'
    }));


    it('should show engine profile (Cognito 1.0.1)', expectEngineProfile(patchEngineProfileXML, {
      executionPlatform: 'Cognito Platform',
      executionPlatformVersion: '1.0.1'
    }));


    it('should open as Cognito Platform if unknown execution profile', async function() {
