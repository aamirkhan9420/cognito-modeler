...
const HELP_LINKS = {
  [ ENGINES.COGNITO ]: 'https://docs.cognito.vodafone.com/', // URL not changed
...
export function getStatusBarLabel(engineProfile) {
  ...
  if (!executionPlatformVersion) {
    ...
    return `Cognito ${toDisplayVersion(engineProfile)}`;
  }
}
