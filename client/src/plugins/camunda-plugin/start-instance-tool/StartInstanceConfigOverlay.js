          ...
          { form => (
            <form onSubmit={ form.handleSubmit } style={ { height: height } }>
              ...
              <Section>
                ...
                <Section.Body>
                  <p className="intro">
                    Enter details to start a process instance on Cognito Platform. Alternatively, you can start a process instance <a href="https://docs.cognito.vodafone.com/manual/latest/reference/rest/process-definition/post-start-process-instance/#request">via a Rest Client</a>.
                  </p>
