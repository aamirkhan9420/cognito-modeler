...
export const GenericApiErrorMessages = {
  ...
  [ CONNECTION_FAILED ]: 'Should point to a running Cognito REST API.',
  ...
  [ NOT_FOUND ]: 'Should point to a running Cognito REST API.',
  [ INTERNAL_SERVER_ERROR ]: 'Cognito is reporting an error. Please check the server status.',
  [ UNAVAILABLE_ERROR ]: 'Cognito is reporting an error. Please check the server status.'
};
