...
import CognitoModelerModdle from '../moddle/cognito-bpmn-modeler-moddle.json';
...
export async function getBpmnDefinitions(xml, diagramType, modelerModdle = CognitoModelerModdle) {
